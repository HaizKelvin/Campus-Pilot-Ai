  ...
  return (
    <div className="flex h-screen bg-slate-950 font-sans overflow-hidden text-slate-50 relative">
      ...
      <motion.aside 
        ...
        className="hidden md:flex glass rounded-none border-y-0 border-l-0 border-r border-white/10 flex-col z-50 shrink-0 m-4 shadow-2xl"
      >
          ...
          {navItems.map((item) => (
            <button
              ...
              className={cn(
                ...
                activeTab === item.id 
                  ? "bg-blue-500/10 text-blue-400 border-l-4 border-blue-500 rounded-l-none pl-2" 
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto relative p-2 md:p-4 flex flex-col gap-4 pb-24 md:pb-4">
